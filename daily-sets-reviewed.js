...
window.COMMON_GROUND_DAILY_SETS = [
  ...
  easy: {
    ...
    tiles: [
      { label: "Fish", correctSlot: "S1", logicNote: "A fish is an animal that lives in water, but it does not have a shell.", fact: "Some fish, like the lungfish, can survive out of water for months by burrowing into mud and breathing air through primitive lungs." },
      ...
      { label: "Seashell", correctSlot: "S3", logicNote: "A seashell is connected to water and has a shell, but it is not an animal itself.", fact: "The 'ocean sound' you hear in a large seashell is actually ambient noise resonating inside the shell's cavity — not the ocean at all." },
      { label: "Sea Turtle", correctSlot: "S4", logicNote: "A sea turtle is an animal that lives in water and has a shell.", fact: "Sea turtles navigate using Earth's magnetic field — females return to the exact beach where they hatched, sometimes traveling thousands of miles." },
  ...
  medium: {
    ...
    tiles: [
      ...
      { label: "Las Vegas", correctSlot: "S2", logicNote: "Las Vegas is a U.S. city that starts with L, but it has not hosted the Olympics.", fact: "Las Vegas uses so much electricity that the city's glow can be seen by airline pilots hundreds of miles away." },
  ...
  hard: {
    ...
    tiles: [
      ...
      { label: "Back to the Future", correctSlot: "S2", logicNote: "Back to the Future is a movie with future travel, but it was not based on a book.", fact: "The time machine was originally a refrigerator in the script — it was changed to a DeLorean partly because Spielberg worried kids might climb into fridges." },
  ...
  easy: {
    ...
    tiles: [
      ...
      { label: "Whale", correctSlot: "S2", logicNote: "A whale is an animal that gives milk to its young, but it is not a farm animal.", fact: "Blue whale milk is about 35-50% fat — roughly 10 times fattier than cow's milk — helping calves gain up to 200 pounds per day." },
      { label: "Dairy Barn", correctSlot: "S3", logicNote: "A dairy barn is on a farm and is connected to milk, but it is not an animal.", fact: "Many modern dairy barns use robotic milking systems that let cows choose when to be milked — some visit the robot three or more times a day." },
      { label: "Cow", correctSlot: "S4", logicNote: "A cow is a farm animal that gives milk.", fact: "Cows have best friends — studies show their stress hormones rise significantly when they are separated from their preferred companion." },
  ...
  medium: {
    ...
    tiles: [
      ...
      { label: "Microsoft", correctSlot: "S2", logicNote: "Microsoft is a brand that starts with M, but it is not fast food.", fact: "Microsoft's first product was a version of BASIC for the Altair 8800 — Gates and Allen wrote it without ever touching the actual computer." },
      ...
      { label: "McDonald's", correctSlot: "S4", logicNote: "McDonald's is a fast-food brand that starts with M.", fact: "McDonald's sells roughly 2.5 billion hamburgers per year — that works out to about 75 burgers every single second." },
  ...
  hard: {
    ...
    tiles: [
      ...
      { label: "Montana", correctSlot: "S2", logicNote: "Montana is a U.S. state that starts with M, but it does not have an NBA team.", fact: "Montana has more cattle than people — roughly 2.6 million cows compared to about 1.1 million human residents." },
      ...
      { label: "Minnesota", correctSlot: "S4", logicNote: "Minnesota is a U.S. state that starts with M and has an NBA team.", fact: "The Timberwolves are one of only a few NBA teams named after an animal native to their state — gray wolves still roam northern Minnesota." },
  ...
  easy: {
    ...
    tiles: [
      ...
      { label: "Soup", correctSlot: "S2", logicNote: "Soup is hot food, but it is not mainly thought of as breakfast.", fact: "The oldest known soup recipes date back roughly 6,000 years — ancient peoples heated water with hot stones dropped into waterproof containers." },
      ...
      { label: "Pancakes", correctSlot: "S4", logicNote: "Pancakes are hot breakfast food.", fact: "Pancakes are one of the oldest prepared foods — ancient Greeks and Romans ate versions sweetened with honey as far back as 500 BC." },
  ...
  medium: {
    ...
    tiles: [
      ...
      { label: "Justin Bieber", correctSlot: "S2", logicNote: "Justin Bieber is a singer whose first name starts with J, but he is not mainly known as an actor.", fact: "Justin Bieber was discovered when talent manager Scooter Braun accidentally clicked on one of his YouTube videos while searching for someone else." },
      { label: "Jennifer Aniston", correctSlot: "S3", logicNote: "Jennifer Aniston is an actor whose first name starts with J, but she is not mainly known as a singer.", fact: "Jennifer Aniston almost turned down the role of Rachel on Friends — she was already committed to a different CBS sitcom that was eventually canceled." },
      { label: "Jennifer Lopez", correctSlot: "S4", logicNote: "Jennifer Lopez is a singer and actor whose first name starts with J.", fact: "Jennifer Lopez's green Versace dress at the 2000 Grammys generated so many search queries that Google created Google Images because of it." },
  ...
  hard: {
    ...
    tiles: [
      ...
      { label: "Strasbourg", correctSlot: "S3", logicNote: "Strasbourg starts with S and uses the euro, but it is a city rather than a country.", fact: "Strasbourg has switched between French and German control four times since 1681 and now serves as a seat of the European Parliament." },
      { label: "Spain", correctSlot: "S4", logicNote: "Spain is a country that starts with S and uses the euro.", fact: "Spain minted a commemorative 2-euro coin featuring Don Quixote — making Cervantes' fictional knight legal tender across Europe." },
  ...
  easy: {
    ...
    tiles: [
      ...
      { label: "Surfing", correctSlot: "S4", logicNote: "Surfing is a water sport that uses a board.", fact: "Ancient Hawaiian royalty considered surfing sacred — chiefs proved their status by riding the biggest waves on exclusive beaches." },
  ...
  medium: {
    ...
    tiles: [
      { label: "South Africa", correctSlot: "S1", logicNote: "South Africa is a country in the Southern Hemisphere, but it does not start with A.", fact: "South Africa is the only country in the world with three capital cities — Pretoria, Cape Town, and Bloemfontein." },
      { label: "Austria", correctSlot: "S2", logicNote: "Austria is a country that starts with A, but it is in the Northern Hemisphere.", fact: "The croissant was reportedly invented in Vienna, Austria — not France — to celebrate the defeat of the Ottoman siege in 1683." },
      { label: "Antarctica", correctSlot: "S3", logicNote: "Antarctica is in the Southern Hemisphere and starts with A, but it is a continent rather than a country.", fact: "Antarctica is technically the world's largest desert — it receives less than two inches of precipitation per year." },
      { label: "Australia", correctSlot: "S4", logicNote: "Australia is a country in the Southern Hemisphere that starts with A.", fact: "Australia is the only continent without any active volcanoes on its mainland." },
  ...
  hard: {
    ...
    tiles: [
      ...
      { label: "Peru", correctSlot: "S1", logicNote: "Peru is a country that starts with P, but its coastline is on the Pacific, not the Atlantic.", fact: "Peru's Nazca Lines — enormous ancient geoglyphs visible only from the air — have puzzled researchers since their discovery." },
      ...
      { label: "Portugal", correctSlot: "S4", logicNote: "Portugal is a country that starts with P and has Atlantic coastline.", fact: "Portugal is the oldest nation-state in Europe — its borders have remained essentially unchanged since 1249." },
  ...
  easy: {
    ...
    tiles: [
      ...
      { label: "Ant", correctSlot: "S2", logicNote: "An ant is a small animal, but it is not a pet.", fact: "Ants have been farming fungi for about 60 million years — far longer than humans have practiced any form of agriculture." },
  ...
  medium: {
    ...
    tiles: [
      { label: "Apollo 13", correctSlot: "S1", logicNote: "Apollo 13 is a movie based on a true story, but it is not about sports.", fact: "The Apollo 13 crew used the lunar module as a makeshift lifeboat — a workaround that NASA engineers improvised in real time." },
  ...
  hard: {
    ...
    tiles: [
      { label: "United States", correctSlot: "S1", logicNote: "The United States is a country formed from former British colonies, but it drives on the right, not the left.", fact: "The thirteen colonies had a combined population of only about 2.5 million when they declared independence in 1776." },
      ...
      { label: "Hong Kong", correctSlot: "S3", logicNote: "Hong Kong was a British colony and drives on the left, but it is not a country.", fact: "Hong Kong still drives on the left while mainland China drives on the right — creating a lane-switching system at the border crossings." },
      { label: "India", correctSlot: "S4", logicNote: "India is a country, was a British colony, and drives on the left.", fact: "India has the second-largest road network in the world at over 3.9 million miles — and all of it is driven on the left." },
  ...
  easy: {
    ...
    tiles: [
      ...
      { label: "Fire Ant", correctSlot: "S3", logicNote: "A fire ant is red and small, but it is not a fruit.", fact: "Fire ant colonies survive floods by linking their bodies together into a waterproof living raft that can float for weeks." },
  ...
  medium: {
    ...
    tiles: [
      { label: "Amazon", correctSlot: "S1", logicNote: "Amazon is a brand founded in Seattle, but it is not a coffee brand.", fact: "Jeff Bezos originally wanted to name Amazon 'Cadabra' but his lawyer misheard it as 'cadaver,' so he changed it." },
      ...
      { label: "Starbucks", correctSlot: "S4", logicNote: "Starbucks is a coffee brand founded in Seattle.", fact: "Starbucks was named after Starbuck, the coffee-loving first mate in Herman Melville's Moby-Dick." },
  ...
  hard: {
    ...
    tiles: [
      ...
      { label: "Mark Twain", correctSlot: "S2", logicNote: "Mark Twain was a U.S. author and novelist, but he did not win a Nobel Prize.", fact: "Mark Twain was born in 1835 when Halley's Comet appeared and died in 1910 when it returned — he predicted the coincidence a year before his death." },
  ...
  easy: {
    ...
    tiles: [
      { label: "Eagle", correctSlot: "S1", logicNote: "An eagle is an animal with wings, but it can fly.", fact: "Bald eagles can spot a rabbit from over two miles away — their vision is roughly four to eight times sharper than a human's." },
      { label: "Elephant", correctSlot: "S2", logicNote: "An elephant is an animal that cannot fly, but it does not have wings.", fact: "Elephants can recognize themselves in mirrors — one of only a few species to pass the self-recognition test." },
      { label: "Paper Airplane", correctSlot: "S3", logicNote: "A paper airplane has wings and cannot fly, but it is not an animal.", fact: "The world record for paper airplane distance is over 226 feet — nearly the length of a Boeing 747." },
      { label: "Ostrich", correctSlot: "S4", logicNote: "An ostrich is an animal with wings that cannot fly.", fact: "Ostriches can sprint at up to 45 mph — faster than most horses — making them the fastest two-legged animal on Earth." },
  ...
  medium: {
    ...
    tiles: [
      ...
      { label: "Madison", correctSlot: "S2", logicNote: "Madison is a city that starts with M, but it does not have an NBA team.", fact: "Madison is built on an isthmus between two lakes — Lake Mendota and Lake Monona — giving it a unique geography for a state capital." },
      { label: "Mavericks", correctSlot: "S3", logicNote: "Mavericks starts with M and is an NBA team, but it is a team name rather than a city.", fact: "Dirk Nowitzki played all 21 of his NBA seasons with the Mavericks — the longest single-team career by a non-American player." },
      { label: "Miami", correctSlot: "S4", logicNote: "Miami is a city that starts with M and has an NBA team.", fact: "The Miami Heat retired Michael Jordan's #23 even though he never played for them — a tribute to his impact on basketball." },
      { label: "Mountain", correctSlot: null },
  ...
  hard: {
    ...
    tiles: [
      ...
      { label: "Taxi Driver", correctSlot: "S3", logicNote: "Taxi Driver is a movie set in New York, but it is not a musical.", fact: "Robert De Niro reportedly obtained a real taxi hack license and drove cabs around New York City to prepare for the role." },
      ...
      { label: "West Side Story", correctSlot: "S4", logicNote: "West Side Story is a musical, a movie, and set in New York.", fact: "West Side Story took over a decade to develop — Bernstein and Robbins first discussed the idea in 1949, but it didn’t premiere until 1957." },
  ...
  medium: {
    ...
    tiles: [
      ...
      { label: "Peru", correctSlot: "S1", logicNote: "Peru is a South American country, but its capital is Lima, not a B-name.", fact: "Peru is home to Machu Picchu, one of the best-known Inca sites." },
